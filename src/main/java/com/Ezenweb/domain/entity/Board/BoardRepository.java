...
public interface BoardRepository extends JpaRepositoryImplementation<BoardEntity , Integer > {
    ...
    // 2. 내용 검색
    @Query(value = "select * from board where bcno = :bcno and bcontent %:keyword%" , nativeQuery = true)
